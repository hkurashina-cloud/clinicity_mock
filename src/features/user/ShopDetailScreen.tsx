...
export default function ShopDetailScreen({
    ...
    // Random Availability Generator (トップ用)
                        ...
                        <section className="py-6 border-b border-gray-50">
                            ...
                            <div className="flex overflow-x-auto px-4 pb-2 gap-3 no-scrollbar">
                                {availability.map((item, idx) => (
                                    <div
                                        key={idx}
                                        className={`flex-shrink-0 flex flex-col items-center justify-center w-14 h-16 rounded-2xl border ${
                                            idx === 1
                                    ...
                                    >
                                        <span
                                            className={`text-xs font-bold mb-1 ${
                                                idx === 1 ? 'text-blue-600' : 'text-gray-500'
                                            }`}
                                        >
                                            {item.weekDay}
                                        </span>
                            ...
                            <div className="px-4 mb-6">
                                ...
                                {shopData.menus
                                    ...
                                    .map((menu) => (
                                        <div
                                            key={menu.id}
                                            className="relative rounded-2xl overflow-hidden shadow-sm border border-gray-100 group mb-4"
                                        >
